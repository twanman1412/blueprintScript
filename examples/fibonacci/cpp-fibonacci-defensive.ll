; ModuleID = 'fibonacci-defensive.cpp'
source_filename = "fibonacci-defensive.cpp"
...
@.str.1 = private unnamed_addr constant [24 x i8] c"fibonacci-defensive.cpp\00", align 1
@__PRETTY_FUNCTION__._Z9fibonaccii = private unnamed_addr constant [27 x i8] c"int32_t fibonacci(int32_t)\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8

; Function Attrs: mustprogress nounwind sspstrong uwtable
define dso_local noundef range(i32 0, -2147483648) i32 @_Z9fibonaccii(i32 noundef %0) local_unnamed_addr #0 {
  %2 = icmp sgt i32 %0, -1
...
5:                                                ; preds = %1
  tail call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 6, ptr noundef nonnull @__PRETTY_FUNCTION__._Z9fibonaccii) #5
  unreachable
...
6:                                                ; preds = %3, %6
  ...
  %8 = phi i32 [ %11, %6 ], [ %0, %3 ]
  %9 = add nsw i32 %8, -1
  %10 = tail call noundef i32 @_Z9fibonaccii(i32 noundef %9)
  %11 = add nsw i32 %8, -2
