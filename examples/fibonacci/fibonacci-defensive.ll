...
define internal fastcc noundef i32 @fibonacci(i32 noundef range(i32 0, 11) %0) unnamed_addr #0 {
entry:
  %switch21 = icmp samesign ult i32 %0, 2
  br i1 %switch21, label %common.ret, label %ifcont5

common.ret:                                       ; preds = %ifcont5, %entry
  %accumulator.tr.lcssa = phi i32 [ 0, %entry ], [ %addtmp, %ifcont5 ]
  %.tr.lcssa = phi i32 [ %0, %entry ], [ %subtmp8, %ifcont5 ]
  %accumulator.ret.tr = add nsw i32 %.tr.lcssa, %accumulator.tr.lcssa
  ret i32 %accumulator.ret.tr

ifcont5:                                          ; preds = %entry, %ifcont5
  %.tr23 = phi i32 [ %subtmp8, %ifcont5 ], [ %0, %entry ]
  %accumulator.tr22 = phi i32 [ %addtmp, %ifcont5 ], [ 0, %entry ]
  %subtmp = add nsw i32 %.tr23, -1
  %calltmp = tail call fastcc noundef i32 @fibonacci(i32 noundef %subtmp)
  %subtmp8 = add nsw i32 %.tr23, -2
  %addtmp = add nsw i32 %calltmp, %accumulator.tr22
  %switch = icmp ult i32 %subtmp8, 2
  br i1 %switch, label %common.ret, label %ifcont5
}

; Function Attrs: nofree nosync nounwind memory(none)
define noundef i32 @main() local_unnamed_addr #1 {
entry:
  %calltmp = tail call fastcc noundef i32 @fibonacci(i32 noundef 10)
