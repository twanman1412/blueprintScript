; ModuleID = 'prime_test.cpp'
source_filename = "prime_test.cpp"
...
8:                                                ; preds = %5
  %9 = icmp samesign ult i32 %0, 9
  br i1 %9, label %18, label %14

10:                                               ; preds = %14
  %11 = add nuw nsw i32 %15, 2
  %12 = udiv i32 %0, %11
  %13 = icmp samesign ugt i32 %11, %12
  br i1 %13, label %18, label %14, !llvm.loop !9

14:                                               ; preds = %8, %10
  %15 = phi i32 [ %11, %10 ], [ 3, %8 ]
  %16 = urem i32 %0, %15
  %17 = icmp ne i32 %16, 0
  br i1 %17, label %10, label %18

18:                                               ; preds = %10, %14, %8, %5, %3, %1
  %19 = phi i1 [ false, %5 ], [ false, %1 ], [ true, %3 ], [ true, %8 ], [ %17, %14 ], [ %17, %10 ]
  ret i1 %19
}
