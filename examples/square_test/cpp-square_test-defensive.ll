; ModuleID = 'square_test-defensive.cpp'
source_filename = "square_test-defensive.cpp"
...
@.str.1 = private unnamed_addr constant [26 x i8] c"square_test-defensive.cpp\00", align 1
@__PRETTY_FUNCTION__._Z8isSquarei = private unnamed_addr constant [26 x i8] c"int32_t isSquare(int32_t)\00", align 1
@_ZSt4cout = external global %"class.std::basic_ostream", align 8

; Function Attrs: mustprogress nounwind sspstrong uwtable
define dso_local noundef range(i32 0, 2) i32 @_Z8isSquarei(i32 noundef %0) local_unnamed_addr #0 {
  %2 = icmp sgt i32 %0, -1
...
5:                                                ; preds = %1
  tail call void @__assert_fail(ptr noundef nonnull @.str, ptr noundef nonnull @.str.1, i32 noundef 6, ptr noundef nonnull @__PRETTY_FUNCTION__._Z8isSquarei) #5
  unreachable
...
define dso_local noundef i32 @main() local_unnamed_addr #2 {
  %1 = tail call noundef nonnull align 8 dereferenceable(8) ptr @_ZNSolsEi(ptr noundef nonnull align 8 dereferenceable(8) @_ZSt4cout, i32 noundef 1)
